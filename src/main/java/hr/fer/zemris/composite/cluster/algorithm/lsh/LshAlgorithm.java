...
public class LshAlgorithm implements IAlgorithm {
  ...
  private static final int FUNCTION_COUNT = 10; // TODO adjust this
  ...
  private BucketStorage computeBucketStorage(final List<IClusterable> clusterables, final double parameter) {
    ...
    final IHashCalculator calculator = producer.produce(FUNCTION_COUNT, parameter);
  ...
  private interface ICalculatorProducer {
    ...
    IHashCalculator produce(int functionCount, double parameter);
